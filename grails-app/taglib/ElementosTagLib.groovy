...
class ElementosTagLib {
    ...
    def notFound = { attrs ->
        ...
        html += '<i class="icon-pencil fa-6x pull-left text-shadow"></i>'
        html += '<p>' + mensaje + '</p>'
        html += '</div>'
        out << html
    }
...
//        html += "<link href=\"${resource(dir: 'bootstrap-3.1.1/css', file: 'bootstrap-theme-simplex.css')}\" rel=\"stylesheet\">"
//        html += "<link href=\"${resource(dir: 'bootstrap-3.1.1/css', file: 'bootstrap-theme-slate.css')}\" rel=\"stylesheet\">"
        out << html
    }
