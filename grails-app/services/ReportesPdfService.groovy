...
//    def dbConnectionService
    ...
    def propiedadesDocumento(Document documento, String title, String keywords) {
        propiedadesDocumento(documento, title, "Generado por el sistema SADA", keywords, "sada", "Fabricio Grijalva")
    }
    ...
    def propiedadesDocumento(Document documento, String title) {
        propiedadesDocumento(documento, title, "reporte, sada")
    }
    ...
    def crearEncabezado(Document documento, String tituloReporte) {
        ...
        headersTitulo.add(new Paragraph("SADA", fontSubtituloGad));
...
//        File layoutFolder = ApplicationHolder.application.parentContext.getResource("images/inicio/hojas_2.jpg").file
        File layoutFolder =   Holders.grailsApplication.parentContext.getResource("images/inicio/hojas_2.jpg").file
...
//        Chunk chunkLogo = new Chunk(logo, x, -10);
        ...
        paragraphHeader.add(new Paragraph("SADA", fontSubtituloGad))
