...
<html>
    ...
    <!-- botones -->
        ...
        <table class="table table-condensed table-bordered table-striped">
            ...
            <tbody>
                <g:each in="${provinciaInstanceList}" status="i" var="provinciaInstance">
                    <tr data-id="${provinciaInstance.id}">
        ...
        <elm:pagination total="${provinciaInstanceCount}" params="${params}"/>
...
//                        log(parts[1], parts[0] == "OK" ? "success" : "error"); // log(msg, type, title, hide)
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar la Provincia seleccionada? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
