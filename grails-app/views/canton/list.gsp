    ...
    <!-- botones -->
        <div class="btn-toolbar toolbar">
            <div class="btn-group">
                <g:link action="form" class="btn btn-default btnCrear">
                    <i class="fa fa-file-o"></i> Nuevo Cantón
                </g:link>
            </div>
            ...
            <tbody>
                <g:each in="${cantonInstanceList}" status="i" var="cantonInstance">
                    <tr data-id="${cantonInstance.id}">
                        ...
                        <td>${fieldValue(bean: cantonInstance, field: "provincia.nombre")}</td>
        ...
        <script type="text/javascript">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Canton seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
