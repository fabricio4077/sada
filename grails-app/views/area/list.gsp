...
<html>
    ...
    <!-- botones -->
            ...
            <tbody>
                <g:each in="${areaInstanceList}" status="i" var="areaInstance">
                    <tr data-id="${areaInstance.id}">
                        ...
                        %{--<td>${fieldValue(bean: areaInstance, field: "codigo")}</td>--}%
        ...
        <elm:pagination total="${areaInstanceCount}" params="${params}"/>
...
//                        log(parts[1], parts[0] == "OK" ? "success" : "error"); // log(msg, type, title, hide)
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Area seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
