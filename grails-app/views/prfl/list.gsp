...
%{--<div class="btn-toolbar toolbar">--}%
    %{--<div class="btn-group">--}%
        %{--<g:link action="form" class="btn btn-default btnCrear">--}%
            %{--<i class="fa fa-file-o"></i> Nuevo Perfil--}%
        %{--</g:link>--}%
    %{--</div>--}%
...
<script type="text/javascript">
    ...
    function deleteRow(itemId) {
        bootbox.dialog({
            title: "Alerta",
            message: "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Prfl seleccionado? Esta acción no se puede deshacer.</p>",
            buttons: {
                cancelar: {
                    label: "Cancelar",
