...
<html>
    <head>
        ...
        <title>Tipo de Norma Legal</title>
    </head>
    <body>
    ...
    <!-- botones -->
        ...
        <table class="table table-condensed table-bordered table-striped">
            ...
            <tbody>
                <g:each in="${tipoNormaInstanceList}" status="i" var="tipoNormaInstance">
                    <tr data-id="${tipoNormaInstance.id}">
        ...
        <elm:pagination total="${tipoNormaInstanceCount}" params="${params}"/>

        <script type="text/javascript">
            var id = null;
            function submitForm() {
                var $form = $("#frmTipoNorma");
